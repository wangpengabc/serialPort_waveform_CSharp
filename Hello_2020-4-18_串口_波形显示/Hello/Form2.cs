...
namespace Hello
{
    public partial class Form2 : Form
    {
        ...
        public Serial_1_OpenPort OpenSerialPort;//定义打开串口委托
        public Serial_1_ClosePort CloseSerialPort;//定义关闭串口委托
        ...
        //{
        //    Graphics mygraphics = e.Graphics; //创建画板,这里的画板是由Form提供的.
        //    Pen p = new Pen(Color.Blue, 2);//定义了一个蓝色,宽度为的画笔
        //    mygraphics.DrawLine(p, 10, 10, 100, 100);//在画板上画直线,起始坐标为(10,10),终点坐标为(100,100)
        //}
